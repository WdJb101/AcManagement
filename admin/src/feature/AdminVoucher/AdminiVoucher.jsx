  ...
  return (
    <div className=" bg-[#F2F3F7]">
      <div className="container lg:px-7 px-4 lg:py-4 min-h-screen bg-[#F4F5F9] mx-auto">
        ...
        <div>
  <div>
    <h1 className="text-center  py-4 text-3xl text-[#004282] font-bold">
      Transaction
    </h1>
  </div>
  <div className="flex flex-col items-center justify-center py-5 bg-gray-100">
    <h2 className="text-xl  text-[#394f64] mb-2">
      Choose Transaction Type
    </h2>
    <div className="relative flex justify-center items-center bg-white shadow-lg rounded-full p-1 w-64">
      <div
